<?php
    ...
    pass varchar(128)not null, roleid int,
    ...
    sucategory varchar(64)not null unique, catid int,
    ...
    itemname varchar(128)not null, catid int,
    foreign key(catid) references Categories(id) on update cascade,
    pricein int not null, pricesale int not null,
    info varchar(256) not null, rate double,
    ...
    customername varchar(32), itemname varchar(128),
    pricein int,pricesale int,
